		...
		<div id="box">
			...
			<form method="post">
				<table class="tab">
					...
					<tr><th>所在地：</th><td><select name="e_dept" id="e_dept"><option value="">--------请选择------------</option><option value="安徽" <?php if($emp_info['e_dept']=='安徽') echo 'selected';?>>安徽</option><option value="北京" <?php if($emp_info['e_dept']=='北京') echo 'selected';?>>北京</option><option value="重庆" <?php if($emp_info['e_dept']=='重庆') echo 'selected';?>>重庆</option><option value="广东" <?php if($emp_info['e_dept']=='广东') echo 'selected';?>>广东</option><option value="广西" <?php if($emp_info['e_dept']=='广西') echo 'selected';?>>广西</option><option value="贵州" <?php if($emp_info['e_dept']=='贵州') echo 'selected';?>>贵州</option></select></td></tr>
					<tr><th>出生日期：</th><td><input type="date" name="e_birth" id="e_birth" value="<?php echo $emp_info['e_birth'];?>"/></td></tr>
					<tr><th>入职时间：</th><td><input type="date" name="e_entry" id="e_entry" value="<?php echo $emp_info['e_entry'];?>" /></td></tr>
